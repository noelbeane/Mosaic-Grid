...
Mosaic Grid is a responsive layout designed to surface content in easy to swallow chunks that encourage further exploration. The main content area is built with the [Masonry](http://masonry.desandro.com/) cascading grid layout. This Javascript library places elements in optimal position based on available vertical space. 
